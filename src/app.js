...
function buildSpecificInstruction(lang) {
  ...
  if (lang === 'en') {
    const map = {
      video: `Create a video explanation about these pages. The video must be completely in English. Make it clear, organized, and easy to understand for my grade level. Include: ${include}.`,
      study: `Help me study only these pages in English. Include: ${include}.`,
      ...
      flashcards: `Create ${a.flashcardCount} flashcards in English to study these pages.\nLevel: ${normalizeAnswer(a.level, lang)}\nFormat:\nQuestion:\nAnswer:\nMake them clear, short, and useful for memorization.`,
      ...
      vocabulary: `Extract ${a.wordCount} important words in English from these pages.${a.vocabularyLanguage ? `\nLanguage: ${a.vocabularyLanguage}` : ''}\nFor each word include:\n\n* Word\n* Simple definition\n* Example\n* Practice question`,
  ...
  const map = {
    video: `Crea una explicación para video sobre estas páginas. El video debe estar completamente en español. Hazla clara, ordenada y fácil de entender para mi grado. Incluye: ${include}.`,
    study: `Ayúdame a estudiar solamente estas páginas en español. Incluye: ${include}.`,
    ...
    flashcards: `Crea ${a.flashcardCount} flashcards en español para estudiar estas páginas.\nNivel: ${a.level}\nFormato:\nPregunta:\nRespuesta:\nHazlas claras, cortas y útiles para memorizar.`,
    ...
    vocabulary: `Extrae ${a.wordCount} palabras importantes en español de estas páginas.${a.vocabularyLanguage ? `\nIdioma: ${a.vocabularyLanguage}` : ''}\nPara cada palabra incluye:\n\n* Palabra\n* Definición sencilla\n* Ejemplo\n* Pregunta de práctica`,
